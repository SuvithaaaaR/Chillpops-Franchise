...
import { FaStore, FaUsers, FaAward, FaHeart, FaLeaf, FaStar, FaHandshake, FaChartLine } from 'react-icons/fa';

const About = () => {
  const [counters, setCounters] = useState({ outlets: 0, cities: 0, customers: 0, years: 0 });
  ...
  const values = [
    {
      ...
      title: "Quality First",
      description: "Premium ingredients, naturally crafted ice cream that delights every customer"
    },
    {
      icon: <FaLeaf className="text-4xl" />,
      title: "Natural Ingredients",
      description: "100% natural flavors with no artificial colors or preservatives"
    },
    {
      icon: <FaStar className="text-4xl" />,
      title: "Innovation",
      description: "Constantly creating new flavors and experiences for our customers"
    },
    {
      icon: <FaHandshake className="text-4xl" />,
      title: "Partnership",
      description: "Building sustainable and profitable relationships with our franchisees"
    }
  ];

  const milestones = [
    { year: "2020", title: "Foundation", desc: "ChillPops was born with a vision to revolutionize frozen desserts" },
    { year: "2021", title: "Expansion", desc: "Opened 15 outlets across 3 cities" },
    { year: "2022", title: "Growth", desc: "Reached 30 outlets in 5 cities" },
    { year: "2023", title: "Recognition", desc: "Awarded 'Best Emerging Ice Cream Brand'" },
    { year: "2024", title: "Scale", desc: "50+ outlets across 8 cities, 100K+ happy customers" }
  ];
  ...
  return (
    <div className="pt-20">
      ...
      <section className="relative section-padding bg-gradient-to-br from-primary via-pink-600 to-purple-600 text-white overflow-hidden">
        ...
        <div className={`container-custom text-center relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fadeInUp">About ChillPops</h1>
          <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="card text-center p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-gradient-to-br from-orange-500 to-pink-600 text-white">
              ...
              <div className="text-5xl font-bold mb-2">{counters.customers.toLocaleString()}+</div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
              <p className="animate-fadeInUp">
                ChillPops began in 2020 with a simple yet powerful dream: to create a frozen
                dessert brand that combines <span className="text-primary font-semibold">premium quality with affordable pricing</span>. 
                We believed that everyone deserves to enjoy naturally crafted, delicious ice cream.
              </p>
              <p className="animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                What started as a single outlet in Karur has now blossomed into a <span className="text-primary font-semibold">thriving network of 50+ outlets</span> across 
                8 major cities in India. Our journey has been fueled by our commitment to quality, 
                innovation, and customer satisfaction.
              </p>
              <p className="animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
                Today, ChillPops is more than just ice cream and popsicles – it's a 
                <span className="text-primary font-semibold"> lifestyle brand</span> that brings joy, refreshment, and memorable moments 
                to families across India. Join us in our journey to spread happiness, one scoop at a time.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 to-white">
        <div className="container-custom">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-12 text-center">Our Journey</h2>
          <div className="max-w-4xl mx-auto">
      ...
      <section className="section-padding bg-gradient-to-r from-primary via-pink-600 to-purple-600 text-white">
        <div className="container-custom text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Join the ChillPops Family</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Be part of India's fastest-growing frozen dessert franchise. Start your profitable business journey today!
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="/apply" className="btn-secondary text-lg px-8 py-4 bg-white text-primary hover:bg-gray-100">
              Apply for Franchise
            </a>
            <a href="/franchise-model" className="btn-primary text-lg px-8 py-4 border-2 border-white hover:bg-white hover:text-primary">
